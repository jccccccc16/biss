...
<script type="text/javascript">
    ...
    function refundClickFunction(orderId){
        $.ajax({
            "url":"alipay/refund.json?orderId="+orderId,
            "method":"get",
...
<%--                                                    class=" glyphicon glyphicon-briefcase"></i></a>--%>
                                            ...
                                            <c:if test="${order.status==4}">
                                                <button onclick="refundClickFunction(${order.id})" title="去退款"
                                                   class="btn btn-warning btn-xs"><i
                                                        class=" glyphicon glyphicon-briefcase"></i></button>
                                            </c:if></td>
                                    </tr>
                                </c:forEach>
                            </c:if>
