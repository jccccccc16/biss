...
<script type="text/javascript">
    ...
    function pageSelectCallback(pageIndex, jQuery) {
        ...
        // 跳转页面
        window.location.href = "member/get/member/page.html?pageNum=" + pageNum + "&keyword=${param.keyword}";
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="member/get/member/page.html" method="post" class="form-inline" role="form"
                          style="float: left;">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <c:if test="${!empty requestScope.pageInfo.list }">
                                <c:forEach items="${requestScope.pageInfo.list }" var="member" varStatus="myStatus">
                                    <tr>
                                        ...
                                        <td>
                                            <c:if test="${member.authstatus==0}">停用</c:if>
                                            <c:if test="${member.authstatus==1}">可用</c:if>
                                        </td>
										<td>
